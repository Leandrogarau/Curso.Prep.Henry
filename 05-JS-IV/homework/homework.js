...
function agregarPropiedad(objeto, property) {
  ...
  // Tu código:
 console.log (objeto [property] = null)
  return objeto 
...
function multiplicarNumeroDesconocidoPorCinco(objetoMisterioso) {
  ...
  // Tu código:
  var y = 0
 y = y + objetoMisterioso.numeroMisterioso * 5 
 return y
} 
...
function agregarMetodoCalculoDescuento(producto) {
  ...
  // Tu código:
producto.calcularPrecioDescuento = function nuevafuncion () { return  this.precio - (this.precio * this.porcentajeDeDescuento) 
}
return producto
}
